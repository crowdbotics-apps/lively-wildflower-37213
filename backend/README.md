...
## Project Structure
    ...
    ├── lively_wildflower_37213  # Django project configurations
...
1. Clone this repo and `cd lively_wildflower_37213`
...
2. Clone this repo and `cd lively_wildflower_37213`
